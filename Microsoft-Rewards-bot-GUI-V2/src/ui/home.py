...
import json
import copy
from src.core import Farmer, WebDriver
...
class Home(ft.UserControl):
    ...
    def ui(self):
        ...
        self.current_points_label = ft.Text("Current point:", font_family="SF regular")
    ...
    def look_for_log_in_accounts(self):
        ...
        for account in self.accounts:
            ...
            for key, value in default_log_dict.items():
                if not account["log"].get(key, False) or not isinstance(account["log"][key], type(value)):
