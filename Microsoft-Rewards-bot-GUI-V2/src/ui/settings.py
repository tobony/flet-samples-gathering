...
class Settings(ft.UserControl):
    ...
    def ui(self):
        ...
        self.speed_dropdown_field = ft.Dropdown(
            ...
            on_change=lambda e: self.page.client_storage.set("MRFarmer.speed", e.data)
        )
        ...
        self.msn_shopping_game_switch = ft.Switch(
            ...
            on_change=lambda e: self.switches_on_change(e, "msn_shopping_game")
        )
    ...
    def set_initial_values(self):
        ...
        if self.page.client_storage.contains_key("MRFarmer.speed"):
            self.speed_dropdown_field.value = self.page.client_storage.get("MRFarmer.speed")
        else:
